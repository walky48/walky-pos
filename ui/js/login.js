...
function loginHTML(){
  ...
  const remote = !viewerEnabled ? `
    ...
    <p class="muted small mt8">Yönetici veya muhasebe hesabıyla (kasadaki kullanıcı adı/şifre) her zaman uzaktan giriş yapılabilir (yönetici salt-okunur kalır); tam erişim ve garson/depo sipariş girişi ise bu restoran Kullanıcılar > Ayarlar'dan hangilerini açtıysa ona göre çalışır.</p>
