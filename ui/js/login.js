...
function loginHTML(){
  ...
  const remote = !viewerEnabled ? `
    ...
    <p class="muted small mt8">Yönetici hesabıyla (kasadaki kullanıcı adı/şifre) en azından salt-okunur görüntüleme her zaman yapılabilir; tam erişim ve garson sipariş girişi bu restoran Kullanıcılar > Ayarlar'dan hangilerini açtıysa ona göre çalışır.</p>
